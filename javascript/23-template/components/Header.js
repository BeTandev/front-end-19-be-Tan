                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <nav class="mx-auto">
                            <div class="search-bar">
                                <form class="search" method="get" action="search.html" id="search-form">
                                    <input type="search" class="search__input" name="keyword"
                        ...
                        <ul class="navbar-nav" id="main-menu">
                            <li class="nav-item active" id="header-menu">
